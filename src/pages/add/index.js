    ...
    <div className='w-full'>
      ...
      <div className='w-full'>
        <form className='w-full space-y-5 font-normal tracking-wider' >
          ...
          <div className='w-1/3'>
            <input placeholder='Enter roll number 0-99999' type="number" className="bg-white w-full py-2 px-5 rounded-md border-[1px] focus:border-[#F33823] outline-none text-gray-600 placeholder-gray-600 border-[#F33823]/30" {...register("regno", { required: true,min: 0, max: 99999 })} />
